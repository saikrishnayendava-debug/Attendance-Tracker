...
const Form = ({ close }) => {
    ...
    const allBranches = ['CSE', 'ECE', 'EEE', 'MECH', 'CIVL', 'IT', 'AIDS', 'CS-AI', 'CS-D', 'CS-C', 'ECM'];
    ...
    const handleBranchChange = (e) => {
        ...
        } else if (selectedBranch && !data.branch.includes(selectedBranch)) {
            setData((prev) => ({
                ...prev,
                        ...
                        <div className='grid grid-cols-2 w-full'>
                            ...
                            {branch ? (
                                ...
                                >
                                    ...
                                    <option className='text-xs font-bold' value="ALL">All Branches</option>
